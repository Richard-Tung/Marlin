...
#include "env_validate.h"
  ...
  #define BOARD_INFO_NAME "FYSETC SPIDER USER"
#endif
...
#define Z2_STEP_PIN                         PE2
#define Z2_DIR_PIN                          PE4
#define Z2_ENABLE_PIN                       PE3
#define Z2_CS_PIN                           PC15

#define Z3_STEP_PIN                         PD12
#define Z3_DIR_PIN                          PC4
#define Z3_ENABLE_PIN                       PE8
#define Z3_CS_PIN                           PA15
...
#define SERVO0_PIN                          PA2
  ...
  #define Z2_SERIAL_TX_PIN                  PC15
  #define Z2_SERIAL_RX_PIN      Z2_SERIAL_TX_PIN

  #define Z3_SERIAL_TX_PIN                  PA15
